...
def get_curve(name: str) -> CurveParams:
    ...
    Raises:
        KeyError: If the curve name is not registered.
    """
    key = name.lower().strip()
    if key not in _REGISTRY:
        available = ", ".join(sorted(_REGISTRY))
        raise KeyError(f"Unknown curve '{name}'. Available: {available}")
    e = _REGISTRY[key]
    return CurveParams(p=e["p"], a=e["a"], b=e["b"], n=e["n"], h=e["h"])


def get_generator(name: str) -> Point:
    ...
    return Point(x=e["Gx"], y=e["Gy"], curve=curve)
