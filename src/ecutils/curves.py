...
def get(name: str, use_projective_coordinates: bool = True) -> EllipticCurve:
    """Retrieve an EllipticCurve instance by its standard name.

    Args:
        name (str): The standard name of the elliptic curve to retrieve.
        use_projective_coordinates (bool): Whether to use projective coordinates.

    Returns:
        EllipticCurve: The corresponding EllipticCurve instance.
    ...
    return EllipticCurve(
        ...
        n=params["n"],
        h=params["h"],
        use_projective_coordinates=use_projective_coordinates,
    )


# Pre-create the standard curve instances for easy import
secp192k1 = get("secp192k1")
secp192r1 = get("secp192r1")
secp224k1 = get("secp224k1")
secp224r1 = get("secp224r1")
secp256k1 = get("secp256k1")
secp256r1 = get("secp256r1")
secp384r1 = get("secp384r1")
secp521r1 = get("secp521r1")
