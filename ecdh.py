...
import os
from ecc import trapdoor, G


rute_private_key = int.from_bytes(os.urandom(32), byteorder='little')

rute_public_key = trapdoor(G, rute_private_key)
...
sibele_public_key = trapdoor(G, sibele_private_key)
...
rute_shared_key = trapdoor(sibele_public_key, rute_private_key)

print('-'*50)
print('Chave compartilhada de Rute:', rute_shared_key)

sibele_shared_key = trapdoor(rute_public_key, sibele_private_key)
